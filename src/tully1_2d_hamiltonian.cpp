...
namespace mqc {
    ...
    Tully1_2D_Hamiltonian::Tully1_2D_Hamiltonian() 
    : Hamiltonian(2) { 
        m_doc = 
    ...
    double Tully1_2D_Hamiltonian::cal_phi(const std::vector<double>& r) const {
        return m_params.at("Wx") * r.at(0) + m_params.at("Wy") * r.at(1);
    }

    std::vector<double> Tully1_2D_Hamiltonian::cal_nabla_phi(const std::vector<double>& r) const {
    ...
    std::vector<std::complex<double>> Tully1_2D_Hamiltonian::cal_H(const std::vector<double>& r) const {
        /**
         * input : r
         * output : H(r)
         */
        // check
        misc::confirm(r.size() == 2, "Tully1_2D_Hamiltonian: nuclear dim must be 2.");
        // params
    ...
    std::vector<std::vector<std::complex<double>>> Tully1_2D_Hamiltonian::cal_nablaH(const std::vector<double>& r) const {
        /**
         * input : r
         * output : nablaH(r)
         */
