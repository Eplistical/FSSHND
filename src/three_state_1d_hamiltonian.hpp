#ifndef _THREE_STATE_1D_HAMILTONIAN_HPP
#define _THREE_STATE_1D_HAMILTONIAN_HPP

/* 
 * Three_State_1d Hamiltonian
 */
...
namespace mqc {
    ...
    class Three_State_1d_Hamiltonian final : public Hamiltonian {
        public:
            // --- ctor/dtor/operator= --- //
            explicit Three_State_1d_Hamiltonian();
            Three_State_1d_Hamiltonian(const Three_State_1d_Hamiltonian& /* other */) = default;
            Three_State_1d_Hamiltonian& operator=(const Three_State_1d_Hamiltonian& /* other */) = default;
            ~Three_State_1d_Hamiltonian() = default;
        private:
            // --- utils --- //
...
#endif // _THREE_STATE_1D_HAMILTONIAN_HPP
